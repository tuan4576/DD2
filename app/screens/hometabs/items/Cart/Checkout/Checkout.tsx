...
const Checkout = ({ navigation }: { navigation: any }) => {
  ...
  const handlePayPalPayment = async () => {
    try {
      const payment = await requestOneTimePayment(
        'AR-3LrVqYrrNxugxqTs3U6Nl4pziemBO4SdQ6w9xjg6rL-br22QsNczFq2lyCRg8F-YYXOIpA-2Ge3ZU',
        {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Nút Thanh toán và Hoàn tất đơn hàng */}
      <TouchableOpacity style={styles.payButton} onPress={selectedPaymentMethod === 'Paypal' ? handlePayPalPayment : handleCreateOrder}>
        <Text style={styles.payButtonText}>Thanh toán và Hoàn tất đơn hàng</Text>
      </TouchableOpacity>
    </ScrollView>
  );
